...
public class CameraFollow : MonoBehaviour
{
    ...
    public Vector2 mapHalfExtent = new Vector2(20f, 20f); // 가로/세로 절반 크기. Player_Movement/EnemySpawner의 mapHalfExtent와 맞춰야 함
    ...
    private void LateUpdate()
    {
        ...
        if (cam != null && cam.orthographic)
        {
            ...
            float limitX = Mathf.Max(0f, mapHalfExtent.x - halfViewWidth);
            float limitY = Mathf.Max(0f, mapHalfExtent.y - halfViewHeight);
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireCube(new Vector3(mapCenter.x, mapCenter.y, 0f), new Vector3(mapHalfExtent.x * 2f, mapHalfExtent.y * 2f, 0f));
    }
}
