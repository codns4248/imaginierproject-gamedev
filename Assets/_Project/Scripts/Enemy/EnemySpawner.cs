...
public class EnemySpawner : MonoBehaviour
{
    ...
    public Vector2 mapHalfExtent = new Vector2(20f, 20f); // 가로/세로 절반 크기. Player_Movement의 mapHalfExtent와 맞춰야 한다
    ...
    private Vector2 FindOffScreenPosition()
    {
        ...
        {
            float x = mapCenter.x + Random.Range(-mapHalfExtent.x, mapHalfExtent.x);
            float y = mapCenter.y + Random.Range(-mapHalfExtent.y, mapHalfExtent.y);
        ...
        return new Vector2(mapCenter.x + mapHalfExtent.x - 0.5f, mapCenter.y + mapHalfExtent.y - 0.5f);
    }
}
